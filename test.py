...
if __name__ == '__main__':
    ...
    # Load dataset
    test_data_loader = blenderLoader(os.path.join(base_dir, meta_file), img_base_dir=base_dir, N_rand=N_rand, skip=args.image_skip, res_half=args.res_half)
    ...
    loss_history = []
    with trange(0, len(test_data_loader)) as progress_bar:
